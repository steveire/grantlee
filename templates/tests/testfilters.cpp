...
void TestFilters::testStringFilters_data()
{
  ...
  QTest::newRow( "filter-make_list03" ) << QStringLiteral( "{% autoescape off %}{{ a|make_list|stringformat:\"%1\"|safe }}{% endautoescape %}" ) << dict << QStringLiteral( "[u\'&\']" ) << NoError;
  ...
  QTest::newRow( "escapejs01" ) << QStringLiteral( "{{ a|escapejs }}" ) << dict << "testing\\u000D\\u000Ajavascript \\u0027string\\u0022 \\u003Cb\\u003Eescaping\\u003C/b\\u003E" << NoError;
  QTest::newRow( "escapejs02" ) << QStringLiteral( "{% autoescape off %}{{ a|escapejs }}{% endautoescape %}" ) << dict << "testing\\u000D\\u000Ajavascript \\u0027string\\u0022 \\u003Cb\\u003Eescaping\\u003C/b\\u003E" << NoError;
  ...
  QTest::newRow( "filter-stringformat03" ) << ".{{ a|stringformat:\"foo %1 bar\" }}. .{{ b|stringformat:\"baz %2 bat\" }}." << dict << QStringLiteral( ".foo a&lt;b bar. .baz a<b bat." ) << NoError;
  ...
  QTest::newRow( "filter-truncatewords02" ) << "{{ a|truncatewords:\"2\" }} {{ b|truncatewords:\"2\"}}" << dict << QStringLiteral( "alpha &amp; ... alpha &amp; ..." ) << NoError;
...
//
  ...
  QTest::newRow( "filter-ljust02" ) << ".{{ a|ljust:\"5\" }}. .{{ b|ljust:\"5\" }}." << dict << QStringLiteral( ".a&amp;b  . .a&b  ." ) << NoError;

  QTest::newRow( "filter-rjust01" ) << "{% autoescape off %}.{{ a|rjust:\"5\" }}. .{{ b|rjust:\"5\" }}.{% endautoescape %}" << dict << QStringLiteral( ".  a&b. .  a&b." ) << NoError;

  QTest::newRow( "filter-rjust02" ) << ".{{ a|rjust:\"5\" }}. .{{ b|rjust:\"5\" }}." << dict << QStringLiteral( ".  a&amp;b. .  a&b." ) << NoError;

  QTest::newRow( "filter-center01" ) << "{% autoescape off %}.{{ a|center:\"5\" }}. .{{ b|center:\"5\" }}.{% endautoescape %}" << dict << QStringLiteral( ". a&b . . a&b ." ) << NoError;

  QTest::newRow( "filter-center02" ) << ".{{ a|center:\"5\" }}. .{{ b|center:\"5\" }}." << dict << QStringLiteral( ". a&amp;b . . a&b ." ) << NoError;
  ...
  QTest::newRow( "filter-cut03" ) << "{% autoescape off %}{{ a|cut:\"&\" }} {{ b|cut:\"&\" }}{% endautoescape %}" << dict << QStringLiteral( "xy xamp;y" ) << NoError;
  QTest::newRow( "filter-cut04" ) << "{{ a|cut:\"&\" }} {{ b|cut:\"&\" }}" << dict << QStringLiteral( "xy xamp;y" ) << NoError;

  //  Passing ";" to cut can break existing HTML entities, so those strings
  //  are auto-escaped.

  QTest::newRow( "filter-cut05" ) << "{% autoescape off %}{{ a|cut:\";\" }} {{ b|cut:\";\" }}{% endautoescape %}" << dict << QStringLiteral( "x&y x&ampy" ) << NoError;
  QTest::newRow( "filter-cut06" ) << "{{ a|cut:\";\" }} {{ b|cut:\";\" }}" << dict << QStringLiteral( "x&amp;y x&amp;ampy" ) << NoError;
  ...
  QTest::newRow( "filter-escape03" ) << QStringLiteral( "{% autoescape off %}{{ a|escape|escape }}{% endautoescape %}" ) << dict << QStringLiteral( "x&amp;y" ) << NoError;
  QTest::newRow( "filter-escape04" ) << QStringLiteral( "{{ a|escape|escape }}" ) << dict << QStringLiteral( "x&amp;y" ) << NoError;

  //  Force_escape is applied immediately. It can be used to provide
  //  double-escaping, for example.

  QTest::newRow( "filter-force-escape01" ) << QStringLiteral( "{% autoescape off %}{{ a|force_escape }}{% endautoescape %}" ) << dict << QStringLiteral( "x&amp;y" ) << NoError;
  QTest::newRow( "filter-force-escape02" ) << QStringLiteral( "{{ a|force_escape }}" ) << dict << QStringLiteral( "x&amp;y" ) << NoError;
  QTest::newRow( "filter-force-escape03" ) << QStringLiteral( "{% autoescape off %}{{ a|force_escape|force_escape }}{% endautoescape %}" ) << dict << QStringLiteral( "x&amp;amp;y" ) << NoError;
  ...
  QTest::newRow( "filter-force-escape05" ) << QStringLiteral( "{% autoescape off %}{{ a|force_escape|escape }}{% endautoescape %}" ) << dict << QStringLiteral( "x&amp;y" ) << NoError;
  QTest::newRow( "filter-force-escape06" ) << QStringLiteral( "{{ a|force_escape|escape }}" ) << dict << QStringLiteral( "x&amp;y" ) << NoError;
  QTest::newRow( "filter-force-escape07" ) << QStringLiteral( "{% autoescape off %}{{ a|escape|force_escape }}{% endautoescape %}" ) << dict << QStringLiteral( "x&amp;y" ) << NoError;
  ...
  QTest::newRow( "filter-linebreaksbr01" ) << QStringLiteral( "{{ a|linebreaksbr }} {{ b|linebreaksbr }}" ) << dict << QStringLiteral( "x&amp;<br />y x&<br />y" ) << NoError;
  QTest::newRow( "filter-linebreaksbr02" ) << QStringLiteral( "{% autoescape off %}{{ a|linebreaksbr }} {{ b|linebreaksbr }}{% endautoescape %}" ) << dict << QStringLiteral( "x&<br />y x&<br />y" ) << NoError;

  dict.clear();
  dict.insert( QStringLiteral( "a" ), QStringLiteral( "<b>hello</b>" ) );

  QTest::newRow( "filter-safe01" ) << QStringLiteral( "{{ a }} -- {{ a|safe }}" ) << dict << QStringLiteral( "&lt;b&gt;hello&lt;/b&gt; -- <b>hello</b>" ) << NoError;
  QTest::newRow( "filter-safe02" ) << QStringLiteral( "{% autoescape off %}{{ a }} -- {{ a|safe }}{% endautoescape %}" ) << dict << QStringLiteral( "<b>hello</b> -- <b>hello</b>" ) << NoError;

  dict.clear();
  dict.insert( QStringLiteral( "a" ), QVariantList() << QStringLiteral( "&" ) << QStringLiteral( "<" ) );

  QTest::newRow( "filter-safeseq01" ) << "{{ a|join:\", \" }} -- {{ a|safeseq|join:\", \" }}" << dict << QStringLiteral( "&amp;, &lt; -- &, <" ) << NoError;
  QTest::newRow( "filter-safeseq02" ) << "{% autoescape off %}{{ a|join:\", \" }} -- {{ a|safeseq|join:\", \" }}{% endautoescape %}" << dict << QStringLiteral( "&, < -- &, <" ) << NoError;
  ...
  QTest::newRow( "filter-striptags02" ) << QStringLiteral( "{% autoescape off %}{{ a|striptags }} {{ b|striptags }}{% endautoescape %}" ) << dict << QStringLiteral( "x y x y" ) << NoError;
...
void TestFilters::testListFilters_data()
{
  ...
  QTest::newRow( "filter-unordered_list02" ) << QStringLiteral( "{% autoescape off %}{{ a|unordered_list }}{% endautoescape %}" ) << dict << "\t<li>x>\n\t<ul>\n\t\t<li><y</li>\n\t</ul>\n\t</li>" << NoError;
  ...
  QTest::newRow( "filter-unordered_list04" ) << QStringLiteral( "{% autoescape off %}{{ a|unordered_list }}{% endautoescape %}" ) << dict << "\t<li>x>\n\t<ul>\n\t\t<li><y</li>\n\t</ul>\n\t</li>" << NoError;
  ...
  QTest::newRow( "filter-unordered_list05" ) << QStringLiteral( "{% autoescape off %}{{ a|unordered_list }}{% endautoescape %}" ) << dict << "\t<li>x>\n\t<ul>\n\t\t<li><y</li>\n\t</ul>\n\t</li>" << NoError;
  ...
  dict.clear();
  QTest::newRow( "length_is07" ) << "{% if \"X\"|length_is:0 %}Length is 0{% else %}Length not 0{% endif %}" << dict << QStringLiteral( "Length not 0" ) << NoError;
  QTest::newRow( "length_is08" ) << "{% if \"X\"|length_is:1 %}Length is 1{% else %}Length not 1{% endif %}" << dict << QStringLiteral( "Length is 1" ) << NoError;
...
//
  ...
  QTest::newRow( "chaining03" ) << "{{ a|cut:\"b\"|capfirst }}.{{ b|cut:\"b\"|capfirst }}" << dict << QStringLiteral( "A &lt; .A < " ) << NoError;
  QTest::newRow( "chaining04" ) << "{% autoescape off %}{{ a|cut:\"b\"|capfirst }}.{{ b|cut:\"b\"|capfirst }}{% endautoescape %}" << dict << QStringLiteral( "A < .A < " ) << NoError;
  ...
  QTest::newRow( "chaining06" ) << QStringLiteral( "{% autoescape off %}{{ a|escape|capfirst }}{% endautoescape %}" ) << dict << QStringLiteral( "A &lt; b" ) << NoError;
  ...
  QTest::newRow( "chaining08" ) << "{% autoescape off %}{{ a|force_escape|cut:\";\" }}{% endautoescape %}" << dict << QStringLiteral( "a &lt b" ) << NoError;
  QTest::newRow( "chaining09" ) << "{{ a|cut:\";\"|force_escape }}" << dict << QStringLiteral( "a &lt; b" ) << NoError;
  QTest::newRow( "chaining10" ) << "{% autoescape off %}{{ a|cut:\";\"|force_escape }}{% endautoescape %}" << dict << QStringLiteral( "a &lt; b" ) << NoError;
  ...
  QTest::newRow( "chaining14" ) << QStringLiteral( "{% autoescape off %}{{ a|safe|force_escape }}{% endautoescape %}" ) << dict << QStringLiteral( "a &lt; b" ) << NoError;
