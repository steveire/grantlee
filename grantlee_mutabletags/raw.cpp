...
Node* RawNodeFactory::getNode( const QString& tagContent, Parser* p, QObject* parent ) const
{
  NodeList nodeList = p->parse( "endraw", parent );
  p->deleteNextToken();
  return new RawNode( nodeList, parent );
}
